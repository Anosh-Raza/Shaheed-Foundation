<?php 
$is_subpage = true;
$page_title = "Endocrinologist - Shaheed Foundation Hospital";
...
<section class="service-hero">
  <img src="https://images.unsplash.com/photo-1559757148-5c350d0d3c56?w=1200&h=400&fit=crop" alt="Endocrinologist" class="hero-bg">
...
<section class="service-detail-section">
  <div class="container">
    <div class="breadcrumb">
      <a href="../index.php">Home</a> » <a href="../services.php">Services</a> » <span>Endocrinologist</span>
    </div>
    ...
    <div class="service-content">
      ...
      <div class="service-image">
        <img src="https://images.unsplash.com/photo-1559757148-5c350d0d3c56?w=500&h=400&fit=crop" alt="Endocrinologist Service">
      </div>
    </div>
  </div>
</section>
