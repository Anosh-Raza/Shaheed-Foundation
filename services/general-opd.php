<?php 
$is_subpage = true;
$page_title = "General OPD - Shaheed Foundation Hospital";
// include($_SERVER['DOCUMENT_ROOT'] . '/shaheed/includes/header.php');
include(__DIR__ . '/../includes/header.php');
?>


<!-- Service Page: General OPD -->
<section class="service-hero">
  <img src="https://images.unsplash.com/photo-1559757148-5c350d0d3c56?w=1200&h=400&fit=crop" alt="General OPD" class="hero-bg">
...
<section class="service-detail-section">
  <div class="container">
    <div class="breadcrumb">
      <a href="../index.php">Home</a> » <a href="../services.php">Services</a> » <span>General OPD</span>
    </div>
    ...
    <div class="service-content">
      ...
      <div class="service-image">
        <img src="https://images.unsplash.com/photo-1559757148-5c350d0d3c56?w=500&h=400&fit=crop" alt="General OPD Service">
      </div>
    </div>
  </div>
</section>
