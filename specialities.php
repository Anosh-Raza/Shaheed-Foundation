  ...
  <div class="container">
      ...
      <div class="specialties-carousel">
        ...
        <div class="specialty-box">
          <a href="services/endocrinologist.php">
            <img src="assets/images/endocrinologist.png" alt="Endocrinologist" />
            <p>Endocrinologist</p>
          </a>
        </div>
        <div class="specialty-box">
    ...
    <div class="specialties-wrapper tab-content" id="upcoming">
      ...
      <div class="specialties-carousel">
        ...
        <div class="specialty-box">
          <img src="assets/images/general-medicine.png" alt="General Medicine" />
          <p>General Medicine</p>
        </div>
        <div class="specialty-box">
          <img src="assets/images/Gynaecology.png" alt="Gynaecology" />
          <p>Gynaecology</p>
        </div>
        <div class="specialty-box">
...
/* Tabs */
.specialty-tabs { display:flex; justify-content:center; gap:12px; margin-bottom:28px; }
.tab-btn{
  background:none; border:2px solid var(--primary-color); color:var(--primary-color);
  padding:8px 18px; font-weight:600; border-radius:6px; cursor:pointer; transition:all .25s;
  font-size:14px;
      box-shadow: 6px 6px 1px 0 var(--secondary-color);
    border: 2px solid var(--white);
    font-family: var(--font-family);
}
.tab-btn.active, .tab-btn:hover { background:var(--primary-color); color:var(--white); }

/* wrapper */
.specialties-wrapper { position:relative; display:none; align-items:center; }
.specialties-wrapper.active { display:flex; }
...
.specialties-carousel::-webkit-scrollbar{ display:none; }
...
.specialty-box a, .specialty-box a *{ text-decoration:none; color:inherit; }
.specialty-box img{ width:80px; height:80px; object-fit:contain; margin-bottom:12px;
filter: brightness(0) saturate(100%) invert(25%) sepia(99%) saturate(7442%) hue-rotate(354deg) brightness(101%) contrast(109%);
}
.specialty-box p{ margin:0; font-weight:600; color:var(--primary-color); }
...
.arrow {
  ...
  z-index:5; box-shadow:0 6px 18px rgba(0,0,0,0.12);
}
.left-arrow{ left:6px; }
.right-arrow{ right:6px; }
.arrow i{ font-size:16px; }
...
@media (max-width:480px){
  .specialty-box{ min-width:84%; padding:20px; 
